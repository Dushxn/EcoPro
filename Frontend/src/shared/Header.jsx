    ...
    <div >
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav>
          ...
          <Link to='/manageFertilizers' >   <li><a href="/" className="hover:font-semibold hover:text-white">Fertilizers</a></li></Link>
          <Link to='/detectDisease' > <li><a href="/about" className="hover:font-semibold hover:text-white">Pests & Diseases</a></li></Link>
          <Link to='/inventory' > <li><a href="/contact" className="hover:font-semibold hover:text-white">Community</a></li></Link>
          </ul>
        </nav>
      </div>
    </header>
